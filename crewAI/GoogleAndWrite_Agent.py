...
search_tool_crewAI = SerperDevTool()
...
task_report = Task(
    ...
    expected_output=
    """
    Output bullet points that MUST contain 3 sentences that refer to one specific ai company, product, model or anything you found on the internet.  
    """,
)
